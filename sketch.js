...
let port;  
let connectBtn;  
let myVal = 0; //use myVal to store the potentiometer readings
...
function draw() {
  ...
  //map the potentiometer readings and then use if statements to split into three groups
  ...
  //depending on the potentiometer readings the background changes and the distorted grid changes
 if (tempo < 1) {
